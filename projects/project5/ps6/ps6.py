...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        #pass #delete this line and replace with your code here
        #save decrpte string message
        sdecrypt = ''
        # count maximum valid word in message
        maxcount = 0
        tup = ()
        RealDecrypt = ''
        #best shift for decrypted message
        bestshift = 0
        
        for i in range(26):
            count = 0
            sdecrp = self.apply_shift(i)
            decrypt = sdecrp.split(' ')
        ...
        tup = (bestshift,RealDecrypt)
        return tup
def decrypt_story():
    story = get_story_string();
    CipherMessage = CiphertextMessage(story)
    tup = CipherMessage.decrypt_message()
    print(tup)
    return tup
